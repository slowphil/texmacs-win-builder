...
@REM  packages removed
@REM  perl-Error perl perl-Authen-SASL perl-libwww perl-MIME-tools ^
@REM	perl-Net-SMTP-SSL perl-TermReadKey dos2unix asciidoc xmlto ^
@REM	mingw-w64-x86_64-git-doc-html git-extra ^
@REM	  mingw-w64-x86_64-toolchain ^
@REM		mingw-w64-x86_64-curl mingw-w64-x86_64-expat ^
@REM		mingw-w64-x86_64-openssl mingw-w64-x86_64-tcl ^
@REM		mingw-w64-x86_64-pcre mingw-w64-x86_64-connect ^
@REM		git-flow
...
@IF NOT DEFINED JENKINS_URL @(
	...
	@ECHO.
@REM	@ECHO Installing the 'Git SDK 32-bit' shortcut on the Desktop
